...
public class P3OneToMainUtil {
	...
	public static void main(String[] args) {
		...
		codeParamEntityIn.setTableName("jp_demo_order_main");//主表名
		codeParamEntityIn.setEntityName("OrderMain");	 //实体名
		...
		po.setTableName("jp_demo_order_custom");//子表名
		po.setEntityName("OrdCustom");	    //实体名
		...
		po2.setTableName("jp_demo_order_product");		//子表名
		po2.setEntityName("OrdProduct");			//实体名
